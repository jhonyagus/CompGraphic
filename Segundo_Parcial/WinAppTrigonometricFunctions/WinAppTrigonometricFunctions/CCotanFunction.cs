...
namespace WinAppTrigonometricFunctions
{
    class CCotanFunction
    {
            ...
            ListBox lstXp, ListBox lstYp, PictureBox picCanvas)
        {
            ...
            for (i = I1; i <= I2; i += 15.0f * (float)Math.PI / 180)
            {
                ...
                else
                {
                    ...
                    mY = mA * (1/(float)Math.Tan(mX)); lstY.Items.Add(mY.ToString());
        ...
        //Funcion que grafica las asintontas de la funcion
        ...
        //Funcion que transforma un arraylist en arreglo de puntoF
