...
namespace WinAppTrigonometricFunctions
{
    class CSecFunction
    {
            ...
            ListBox lstXp, ListBox lstYp, PictureBox picCanvas)
        {
            ...
            for (i = I1; i <= I2; i += 15.0f * (float)Math.PI / 180)
            {
                ...
                else
                {
                    ...
                    mY = mA * (1 / (float)Math.Cos(mX)); lstY.Items.Add(mY.ToString());
        ...
        //Funcion para graficar las asintotas de la funcion
        ...
        //Funcion para transformar de arraylist a areglo de puntosF
        ...
        //Funcion para graficar la curva de la funcion
